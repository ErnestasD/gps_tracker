...
export const KB_META: readonly KbArticleMeta[] = [
  ...
  },
  {
    ...
    surfaces: { site: true, app: true },
    screen: '/app/devices',
    title: { en: 'Retiring, moving and erasing a device', lt: 'Įrenginio išregistravimas, perkėlimas ir duomenų ištrynimas', pl: 'Wycofywanie, przenoszenie i kasowanie urządzenia', de: 'Gerät stilllegen, umsetzen und löschen' },
    summary: {
      ...
      lt: 'Ką daryti, kai sekiklis keičia automobilį, palieka parką arba turi būti išvalytas – ir kas kiekviename veiksme yra negrįžtama.',
  ...
  },
  {
    ...
    summary: {
      ...
      lt: 'Prisijungęs, Atsijungęs, Nepasiekiamas, Niekada nepranešė, Aktyvus ir Išregistruotas – tai dvi skirtingos skalės. Jas supainiojus prarandama popietė.',
