...
export const deviceStatus: KbArticle = {
  ...
  doc: {
    ...
    lt: {
      ...
      summary: 'Prisijungęs, Atsijungęs, Nepasiekiamas, Niekada nepranešė, Aktyvus ir Išregistruotas – tai dvi skirtingos skalės. Jas supainiojus prarandama popietė.',
      keywords: ['būsena', 'prisijungęs', 'neprisijungęs', 'nėra ryšio', 'niekada nesiuntė', 'išregistruotas', 'aktyvus', 'spalva'],
      blocks: [
        ...
        { table: { head: ['Būsena', 'Reiškia', 'Ką daryti'], rows: [
          ...
          ['**Nepasiekiamas**', 'Tyli jau ilgą laiką.', 'Verta pažiūrėti: aprėptis, maitinimas, duomenų limitas.'],
          ['**Niekada nepranešė**', 'Užregistruotas čia ir nė karto nieko neatsiuntė.', 'Montavimas nebaigtas – žr. [Įrenginys nesiunčia duomenų](kb:device-not-reporting).'],
        ] } },
        { callout: 'note', p: 'Šios ribos sąmoningai dosnios. Sekikliai kaupia įrašus ir paprastai išsiunčia kas porą minučių, tad griežtesnė „prisijungęs“ apibrėžtis verstų visiškai sveiką automobilį visą kelionę mirgėti tarp būsenų.' },
        ...
        { table: { head: ['Būsena', 'Reiškia'], rows: [
          ...
          ['**Išregistruotas**', 'Žmogaus išimtas iš eksploatacijos. Nuo šiol jo duomenys nepriimami; istorija lieka skaitoma – žr. [Įrenginio išregistravimas ir ištrynimas](kb:device-lifecycle).'],
        ] } },
        { h2: 'Kodėl žodynas laikomas atskirai', id: 'why-separate' },
        { p: 'Žodis „neaktyvus“ būtų teisingas ir apie nakčiai pastatytą furgoną, ir apie iš parduoto automobilio išimtą sekiklį, o šios dvi situacijos reikalauja priešingų veiksmų. Tylintis automobilis – faktas apie pastarąsias kelias minutes; išregistruotas automobilis – kažkieno priimtas sprendimas. Sąsaja niekada neleidžia vienam žodžiui nešti abiejų.' },
    ...
    pl: {
      ...
      blocks: [
        ...
        { table: { head: ['Status', 'Znaczy'], rows: [
          ...
          ['**Wycofane**', 'Wyjęte z eksploatacji przez człowieka. Jego dane są od tej pory odrzucane; historia pozostaje czytelna — zobacz [Wycofywanie i usuwanie urządzenia](kb:device-lifecycle).'],
        ] } },
