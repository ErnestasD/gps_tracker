    ...
    lt: {
      ...
      blocks: [
        ...
        { table: { head: ['Tipas', 'Suveikia, kai', 'Ko reikia'], rows: [
          ...
          ['**Įrenginys nepasiekiamas**', 'Nieko negirdėti jūsų nurodytą valandų skaičių.', 'Nieko papildomo. Naudingiausia taisyklė visame sąraše ir ta, kurią pamiršta.'],
          ['**Įvesties pokytis**', 'Skaitmeninis įėjimas keičia būseną – durys, PTO, savivartis, šaldytuvo durys, pavojaus grandinė.', 'Prie kažko prijungto įėjimo. Ką tai reiškia, nusprendžia montavimas.'],
        ] } },
        ...
        { ul: [
          '**Įrenginys nepasiekiamas** visai paskyrai. Būtent ji praneša, kad sekiklis mirė, SIM baigėsi arba automobilis nuvarytas ten, kur nėra aprėpties – gedimai, kurie kitaip nematomi kaip tik todėl, kad nieko nevyksta.',
    ...
    pl: {
      ...
      blocks: [
        ...
        { table: { head: ['Rodzaj', 'Wyzwala się, gdy', 'Wymaga'], rows: [
          ...
          ['**Niski poziom baterii**', 'Napięcie spada poniżej ustawionego progu.', 'Urządzenia raportującego napięcie. Próg ustaw pod pojazd, nie zostawiaj domyślnego.'],
        ...
        { table: { head: ['Rodzaj', 'Wyzwala się, gdy', 'Wymaga'], rows: [
          ['**Panika**', 'Naciśnięty zostaje przycisk alarmowy.', 'Podłączonego przycisku. Tej regule daj kanał, który ktoś naprawdę obserwuje.'],
        ...
        { ul: [
          '**Urządzenie offline** dla całego konta. To reguła, która mówi, że lokalizator padł, karta SIM się skończyła albo pojazd pojechał tam, gdzie nie ma zasięgu — awarie niewidoczne właśnie dlatego, że nic się nie dzieje.',
    ...
    de: {
      ...
      blocks: [
        ...
        { table: { head: ['Art', 'Löst aus, wenn', 'Braucht'], rows: [
          ...
          ['**Geschwindigkeit**', 'Die Geschwindigkeit über das in der Regel gesetzte Limit steigt.', 'Nichts zusätzlich. Eine anhaltende Überschreitung ist ein Ereignis mit Endzeit, kein Strom.'],
        ...
        { table: { head: ['Art', 'Löst aus, wenn', 'Braucht'], rows: [
          ...
          ['**Schwache Batterie**', 'Die Spannung unter den von Ihnen gesetzten Schwellwert fällt.', 'Ein Gerät, das Spannung meldet. Setzen Sie den Schwellwert fürs Fahrzeug, nicht den Standard.'],
        ...
        { ul: [
          '**Gerät offline** für das ganze Konto. Sie sagt Ihnen, dass ein Tracker gestorben ist, eine SIM leer wurde oder ein Fahrzeug irgendwohin ohne Abdeckung gefahren ist — Ausfälle, die sonst gerade deshalb unsichtbar sind, weil nichts passiert.',
