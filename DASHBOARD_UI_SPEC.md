...
- **Geofences [E05-1]:** split view — list left (name, type, color chip, rules count), map right with the in-house drawing tool (ADR-040); create flow: draw → form (name, color, accounts scope) → save; area guard error inline.
