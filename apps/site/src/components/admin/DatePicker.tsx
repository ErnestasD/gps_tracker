    ...
    <Popover open={open} onOpenChange={disabled ? undefined : setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          disabled={disabled}
          className={cn(
            "flex h-9 w-full cursor-pointer items-center gap-2 rounded-md border px-3 text-sm outline-none transition-colors disabled:cursor-not-allowed disabled:opacity-50",
            className,
          )}
          style={{
