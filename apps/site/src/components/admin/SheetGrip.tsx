...
export function SheetGrip({
  ...
  return (
    <div
      ...
      className={cn(
        'group flex h-5 shrink-0 cursor-row-resize touch-none items-center justify-center outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--admin-brand)] xl:hidden',
        className,
      )}
    ...
    >
      <span
        ...
        style={{ background: "var(--admin-hairline)" }}
        aria-hidden
      />
    </div>
  )
