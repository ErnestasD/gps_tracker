      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/cookies" className="hover:text-ink text-muted-foreground">Cookies</Link></li>
        ...
        <div>
          ...
          <p className="mt-6 text-xs text-muted-foreground">© {new Date().getFullYear()} Orbetra · MB Dokigo</p>
