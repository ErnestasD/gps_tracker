...
function SetPassword() {
  ...
  return (
    <div className="mx-auto max-w-md px-6 pt-28 md:pt-36 pb-28">
      ...
      <h1 className="display text-3xl md:text-4xl font-bold mt-4 text-ink">Set your password</h1>
      {state === "done" ? (
        <div className="surface-card p-7 mt-8">
          <p className="text-sm text-muted-foreground">Password set. You can sign in now.</p>
          <Link to="/partner/login" className="mt-5 pill-primary hover:pill-primary-hover">Partner sign in</Link>
        </div>
      ) : (
        <form onSubmit={(e) => void onSubmit(e)} className="surface-card p-7 mt-8 grid gap-4">
          <label className="grid gap-1.5">
            <span className="mono text-[10px] tracking-[0.2em] uppercase text-muted-foreground">Invite token</span>
          ...
          <label className="grid gap-1.5">
            <span className="mono text-[10px] tracking-[0.2em] uppercase text-muted-foreground">New password</span>
          ...
          <label className="grid gap-1.5">
            <span className="mono text-[10px] tracking-[0.2em] uppercase text-muted-foreground">Confirm password</span>
