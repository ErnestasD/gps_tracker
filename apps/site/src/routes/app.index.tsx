...
import {
  TrendingUp, Bell, Activity, ArrowRight,
} from "lucide-react";
import {
          ...
          <div style={{ width: "100%", height: 260 }}>
            <ResponsiveContainer>
              <AreaChart data={fleetActivitySeries}>
                ...
                <XAxis dataKey="date" tick={{ fontSize: 10, fill: "var(--admin-ink-soft)" }} tickFormatter={(d: string) => d.slice(5)} tickLine={false} axisLine={false} />
