 ...
 */
export { activateDevice, deactivateDevice, deviceConfigValue, syncDeviceConfig, tenantDevicesKey, suspendTenantDevices, restoreTenantDevices } from '@orbetra/registry'
