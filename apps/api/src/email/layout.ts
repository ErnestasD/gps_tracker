import type { Branding } from '@orbetra/shared'

/**
 * Branded email layout (E03-5). Wraps a message body in the tenant's product name,
 * logo, and accent color. The full send path (SES/Telegram) is E05-4 — this is the
 * layout only, snapshot-tested (AC[3]). All tenant-controlled strings are
 * HTML-escaped; logoUrl is validated https at write time (brandingSchema).
 */
