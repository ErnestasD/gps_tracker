...
export function fakeDb(users: AuthUserRow[] = []): Db {
  ...
  return {
    ...
    affiliates: { list: notImpl, listWithStats: notImpl, get: notImpl, getActiveByCode: notImpl, create: notImpl, update: notImpl, accrueCommission: notImpl, accrueForPaidInvoice: notImpl, recordClick: notImpl, funnelFor: notImpl, listCommissions: notImpl, voidCommissionForRefund: notImpl, listCommissionsForPartner: notImpl, listReferredCustomers: notImpl, setCommissionStatus: notImpl, findByEmailForAuth: notImpl, setPassword: notImpl, createPwToken: notImpl, replacePwToken: notImpl, consumePwToken: notImpl, invalidatePwTokens: notImpl },
