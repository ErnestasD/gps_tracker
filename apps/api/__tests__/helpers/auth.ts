...
export function fakeDb(users: AuthUserRow[] = []): Db {
  ...
  return {
    ...
    tenants: { list: notImpl, get: notImpl, getPlan: notImpl, getEntitlements: notImpl, createSelfServeSignup: notImpl, create: notImpl, update: notImpl, remove: notImpl, updateBranding: notImpl, getBilling: notImpl, setStripeCustomer: notImpl, applySubscriptionEvent: notImpl, listActiveSubscribers: notImpl, listLapsedTenants: notImpl },
