...
export function fakeDb(users: AuthUserRow[] = []): Db {
  ...
  return {
    ...
    tenants: { list: notImpl, get: notImpl, create: notImpl, update: notImpl, remove: notImpl, updateBranding: notImpl, getBilling: notImpl, setStripeCustomer: notImpl, applySubscriptionEvent: notImpl, listActiveSubscribers: notImpl },
    ...
    drivers: { list: notImpl, get: notImpl, findByIbutton: notImpl, create: notImpl, update: notImpl, remove: notImpl },
