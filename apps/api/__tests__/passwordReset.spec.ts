...
function makeUser(over: Partial<AuthUserRow> = {}): AuthUserRow {
  return { id: 'u1', tenantId: 't1', accountId: null, email: 'u@orbetra.test', passwordHash: oldHash, role: 'tsp_admin', locale: 'en', plan: 'tsp_grow', subscriptionStatus: null, currentPeriodEnd: null, ...over }
}
