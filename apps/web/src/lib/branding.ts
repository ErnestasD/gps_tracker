...
/**
 * The tenant's own mail sending identity (ADR-036, audit W-3).
 *
 ...
 *  answer is information, not a failure, and the tenant needs to see it. */
export const verifySendingDomain = () => mutate<SendingDomainRead>('POST', '/v1/tenant/sending-domain/verify')
export const removeSendingDomain = () => mutate<{ ok: boolean }>('DELETE', '/v1/tenant/sending-domain')
